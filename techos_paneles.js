function calculoPanelesEnTecho() {
  ...
  const altoTecho = parseFloat(
    document.querySelector('input[name="altoTecho"]').value
  );

  const baseTecho = parseFloat(
    document.querySelector('input[name="baseTecho"]').value
  );

  //Obtener base y altura del panel solar
  const altoPanel = parseFloat(
    document.querySelector('input[name= "altoPanel"]').value
  );
  const basePanel = parseFloat(
    document.querySelector('input[name="basePanel"]').value
  );
  ...
  if (areaPanel > areaTecho) {
    document.querySelector("#resultado").textContent =
      "Los paneles son muy grandes y no caben en tu techo";
    limpiarCampos();
    return;
  }
  ...
  if (cantidadDePaneles === 1) {
    document.querySelector(
      "h3"
    ).textContent = `Cabe ${cantidadDePaneles} panel solar en el techo`;
  } else {
    document.querySelector(
      "h3"
    ).textContent = `Caben ${cantidadDePaneles} paneles solares en el techo`;
  }
